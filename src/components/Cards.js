            ...
            <div className="cards__wrapper"> 
               ...
               <ScrollAnimation animateIn="fadeIn" duration="2">  
                    <CardItem 
                      ...
                      text="What is PROLTECH ? it's a desktop application that allows you to manage and monitor your IT projects , by using this app you can create projects , invite consultants , and monitor project's performance ..." 
               ...
               <ScrollAnimation animateIn="fadeIn" duration="2">  
                    <CardItem 
                      ...
                      text="This HealthCare application allows Doctors to monitor their patients and manage the patient's medical records and appointments , and it also provides a GPS system with router planner wich makes it easier to find doctor's office ." 
                      label="Android Application"  
